...
?>
<div class="op-block op-block-<?php echo esc_attr( $attributes['carousel'] ? $attributes['blockId'] . ' swiper' : $attributes['blockId'] . ' op-' . $attributes['blockId'] ); ?>">
					...
					<div class="op-woo__category-card op-woo__category <?php echo esc_attr( $attributes['carousel'] ? 'swiper-slide' : '' ); ?>">
						...
						<?php if ( 'one' === $attributes['preset'] ) { ?>
							<a href="<?php echo esc_attr( $category_link ); ?>" class="op-woo__category-pre1 op-woo__card">
								<figure>
									<img class="op-woo__category-image" src="<?php echo esc_attr( $shop_catalog_img[0] ?? OMNIPRESS_URL . 'assets/images/placeholder_category.webp' ); ?>" alt="<?php echo esc_attr( $cata->slug ); ?>" />
								</figure>
						...
						<?php if ( 'two' === $attributes['preset'] ) { ?>
							<a href="<?php echo esc_attr( $category_link ); ?>" class="oop-woo__category-card-content op-woo__category-pre2 op-woo__card">
								<figure>
									<img class="op-woo__category-image" src="<?php echo esc_attr( $shop_catalog_img[0] ?? OMNIPRESS_URL . 'assets/images/placeholder_category.webp' ); ?>" alt="<?php echo esc_attr( $cata->slug ); ?>" />
								</figure>
								<div class="op-woo__category-card-title op-woo__card-content">
									<h3 class="p-woo__category-card-title-name op-woo__category-title"> <?php echo $cata->name; ?> </h3>
								</div>
								<span class="cat-count product-category-count"><?php echo esc_html( $cata->category_count ); ?></span>
							</a>
						<?php } ?>

						<?php if ( 'three' === $attributes['preset'] ) { ?>
							<a href="<?php echo esc_attr( $category_link ); ?>" class="op-woo__category-pre3 op-woo__card" title="<?php echo $cata->name; ?>">
								<div class="op-woo__category-pre3-heading-img">
									<div class="op-woo__category-pre3-label-wrap">
										<h3 class="op-woo__category-pre3-label op-woo__category-title category-title op-woo__category-title"><?php echo $cata->name; ?></h3>
										<span class="at-count product-category-count"><?php echo esc_html( $cata->category_count ); ?> Products</span>
									</div>
									<figure>
										<img class="op-woo__category-image category-image" src="<?php echo esc_attr( $shop_catalog_img[0] ?? OMNIPRESS_URL . 'assets/images/placeholder_category.webp' ); ?>" class="" decoding="async" />
									</figure>
								</div>
							</a>
						<?php } ?>
