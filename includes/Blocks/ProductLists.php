 ...
 * Product Lists Block.
 */
class ProductLists extends WoocommerceProducts {
	 ...
	 */
	public function get_discount( \WC_Product $product ) {
	 ...
	 */
	protected function get_single_product_categories( \WC_Product $product ) {
	 ...
	 */
	public function get_single_product_template( \WC_Product $product, $attributes ) {
		...
		$html = sprintf(
                ...
                <div class="product-item-details">
                    ...
                    <div class="product-item-buttons-wrap">
                        <div class="product-item-buttons">
                            <a href="%s" class="op-add_to_cart"><i class="fa-solid fa-cart-shopping"></i>%s</a>
                        </div>
                    </div>
                </div>
            </div>
			...
			: '',
			$toggle['image'] ? $product->get_image() ?? '' : '',
	 ...
	 */
	public function get_ratings( \WC_Product $product ) {
	...
	public function render( $attributes, $content, $block ): string {
		...
		return sprintf(
			'<div %s><div class="op-block__product-list-wrapper"> <ul class="op-block__product-list-products"> %s </ul></div></div>',
			get_block_wrapper_attributes( array( 'class' => "op-block op-block-{$attributes['blockId']} op-block__product-list" ) ),
			$content
		);
	}
	 ...
	 */
	private function sort_by_price( array &$products, array $attributes ) {
			usort(
				$products,
