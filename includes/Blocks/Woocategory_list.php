 ...
 */
class Woocategory_list extends DynamicAbstract {
	...
	private function start_container( int $layout, $blockId = '' ) {
		return sprintf(
			'<div ' . get_block_wrapper_attributes( array( 'class' => "op-block op-block-{$blockId} op-{$blockId} op-woo__catlist" ) ) . '><div class="op-block op-woo__catlist"><div class="op-woo__catlist-wrapper catlist-layout-%1$d">',
			$layout,
		);
	}
